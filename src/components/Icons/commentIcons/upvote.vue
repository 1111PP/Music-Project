...
<template>
    <svg t="1716293027815" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="2774" :width="width" :height="height">
        <path
...
//排除已被点赞的图标的鼠标经过效果
.icon:hover:not(.liked) path {
    fill: black;
}

// 为已经被点赞的图标添加hover效果
// 选中同时具有 "icon" 和 "liked" 类的元素,添加hover效果
.icon.liked:hover path {
    fill: rgb(199, 0, 0);
}
</style>